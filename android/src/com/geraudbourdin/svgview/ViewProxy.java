...
// This proxy can be created by calling Svgview.createExample({message: "hello
// world"})
...
public class ViewProxy extends TiViewProxy {
  ...
  public void setImage(String val) {
    image = val;
    // from :
    // https://wiki.appcelerator.org/display/guides2/Android+Module+Quick+Start
    ...
    if (view != null) {
      if (!TiApplication.isUIThread()) {
        ...
        TiMessenger.sendBlockingMainMessage(
            new Handler(TiMessenger.getMainMessenger().getLooper(),
